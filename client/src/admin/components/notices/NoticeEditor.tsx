    ...
    return (
        <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
            <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto p-0 gap-0">
                {/* Header */}
                <DialogHeader className="sticky top-0 bg-white border-b px-6 py-4 flex flex-row items-center justify-between space-y-0 z-10">
                ...
                {/* Footer Actions */}
                <DialogFooter className="sticky bottom-0 bg-white border-t px-6 py-4 flex gap-3 justify-end z-10">
